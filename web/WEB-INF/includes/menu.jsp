...
<ul class="nav nav-list">
    <li><img class="nav-list-profile-image" src="/Facebug/Imagem?origem=usuario&id=<%=usuarioLogadoMenu.getId()%>" title="<%=HtmlUtil.xss(usuarioLogadoMenu.getNomeCompleto())%>"  /><br />
