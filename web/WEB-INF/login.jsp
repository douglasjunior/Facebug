...
<%
     Usuario usuarioCadastro = (Usuario) request.getAttribute("usuario_cadastro");
                    ...
                    <div class="span5" >
                        <form name="cadastro" method="POST" action="Login" onsubmit="return validarCadastro();"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" id="cadNome" name="nome" value="<%=HtmlUtil.xss(usuarioCadastro.getNome())%>" size="40" /> 
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="cadSobrenome">Sobrenome</label>
                                <div class="controls">
                                    <input type="text" id="cadSobrenome" name="sobrenome" value="<%=HtmlUtil.xss(usuarioCadastro.getSobrenome())%>" size="40" /> 
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="cadEmail">E-mail</label>
                                <div class="controls">
                                    <input type="text" id="cadEmail" name="email" value="<%=HtmlUtil.xss(usuarioCadastro.getEmail())%>" size="40" /> 
                                </div>
                            </div>
                            <div class="control-group">
